...
-- DEPT_COPY 테이블에 DEPT_ID 컬럼에 PRIMARY KEY 제약조건 추가
...
ADD CONSTRAINT EMPLOYEE_DEPT_CODE FOREIGN KEY (DEPT_CODE) REFERENCES DEPARTMENT
ADD CONSTRAINT EMPLOYEE_JOB_CODE FOREIGN KEY (JOB_CODE) REFERENCES JOB;
...
-- DEPT_COPY 테이블에 SYS_C007337 제약조건명을 DEPT_COPY_DEPT_ID_NN으로 변경
ALTER TABLE DEPT_COPY RENAME CONSTRAINT SYS_C007337 TO DEPT_COPY_DEPT_ID_NN;
